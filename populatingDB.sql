...
insert into Game values(1,"Street Fighters","This is an action game on the street",6,40);
insert into Game values(2,"Adventure in Monkey Island","adventure with your monkey",7,40);
insert into Game values(3,"Sudoku","try our sudoku game",8,10);
insert into Game values(4,"forza","racing game",9,50);
insert into Game values(5,"NBA Live","latest version of NBA Live",6,50);
insert into Game values(6,"Sidewalk Fighters","This is an action game on the sidewalk",6,35);
insert into Game values(7,"Adventure in Rabbit Island","adventure with your rabbit",7,50);
insert into Game values(8,"Crossword","try our crossword game",8,10);
insert into Game values(9,"Vrroom","another racing game",9,60);
insert into Game values(10,"Golf 2017","lastest version of golf Live",6,100);
insert into Game values(11,"Road Fighters","This is an action game on the road",6,30);
insert into Game values(12,"Adventure in Dog Island","adventure with your dog",7,50);
insert into Game values(13,"Sudoku2","try our sudoku2 game",8,5);
insert into Game values(14,"Mario Cart","racing game of people in shopping carts",9,25);
insert into Game values(15,"Swimming?","swimming simulator",6,50);    
...
insert into HasGenre values(6,"Action");
insert into HasGenre values(7,"Adventure");
insert into HasGenre values(8,"Puzzle");
insert into HasGenre values(9,"Racing");
insert into HasGenre values(10,"Sports");
insert into HasGenre values(11,"Action");
insert into HasGenre values(12,"Adventure");
insert into HasGenre values(13,"Puzzle");
insert into HasGenre values(14,"Racing");
insert into HasGenre values(15,"Sports");    

insert into OwnsGame values(1,1,0,50);
insert into OwnsGame values(1,5,100,82);
insert into OwnsGame values(2,2,0,60);
insert into OwnsGame values(2,4,0,80);
insert into OwnsGame values(2,5,0,79);	
insert into OwnsGame values(3,3,0,75);
insert into OwnsGame values(3,4,0,80);
insert into OwnsGame values(4,4,0,40);
insert into OwnsGame values(4,5,0,90);
insert into OwnsGame values(5,5,0,90);
...
insert into Achievement values(7,"Lose every fight","be a loser",100,6);
insert into Achievement values(8,"Rabbit hunt","Find all the rabbits on the island",10,7);
insert into Achievement values(9,"Solve","Find all the words",100,8);
insert into Achievement values(10,"Destroy car","Completely wreck your vehicle",100,9);
insert into Achievement values(11,"Win championship","Win",100,10);
insert into Achievement values(12,"Find all the Huskies","Steal all the huskies on the island",100,11);    
insert into Achievement values(13,"Fight against machines","Fight a car",10,12);
insert into Achievement values(14,"Solve","solve this again",100,13);
insert into Achievement values(15,"Steal","steal another players shopping cart",10,14);
